...
import { FlightOffer, FlightSearchCriteria } from '../../types/flight';
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between px-1">
        <div className="text-xs font-extrabold text-slate-300">
          Available Flight Offers ({offers.length})
        </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800/80 pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-400 mt-0.5 flex items-center gap-2">
                    <span className="capitalize">{offer.cabinClass.replace('_', ' ')}</span>
                    <span>•</span>
                    <span className={offer.seatsAvailable <= 3 ? 'text-rose-400 font-bold' : 'text-slate-400'}>
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-slate-400 font-semibold">
                  ≈ ${offer.fareAmountFiat.toLocaleString(undefined, { minimumFractionDigits: 2 })} {offer.fareCurrency}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
              <div className="flex flex-wrap items-center gap-3 text-xs text-slate-400">
                <div className="flex items-center gap-1 bg-slate-800/70 px-2.5 py-1 rounded-xl">
                  ...
                  <span>{offer.baggage.checkedBaggage}</span>
                </div>
                <div className="text-[11px] text-slate-400">
                  {offer.fareConditions || 'Standard Carrier Policy'}
                </div>
              </div>
